document.addEventListener("DOMContentLoaded", () => {
  ...
  const musicUrls = [
    ...
    "https://files.catbox.moe/5ieb94.mp4",
    "https://files.catbox.moe/5rkgqj.mp4",
    "https://files.catbox.moe/3ncoab.mp4",
    "https://files.catbox.moe/4qal29.mp4",
    "https://files.catbox.moe/cu0iss.mp4",
    "https://files.catbox.moe/suynlu.mp4",
    "https://files.catbox.moe/5g6tbk.mp4",
    "https://files.catbox.moe/e2h2la.mp4",
    "https://files.catbox.moe/h6wz5s.mp4",
  ...
  "Onakka Munthiri",
  "Nagumo",
  "Vaalmunakannile Mariville",
  "Ravin Poonthen Thedum",
  "Vaishaka Sandhye Nin Chundil",
  "Sreeragamo Thedunnu",
  "Azhake Nee Enne Piriyalle",
  "Veera Raja Veera",
  "Ole melody",
  "Kannil Pettole",
  "Thuppathu",
  ...
  socket.on("ndn spotify play", (data) => {
    ...
    spotifyAudio.play().catch(() => {
      ...
      document.addEventListener("click", () => spotifyAudio && spotifyAudio.play().catch(() => {}), { once: true });
    });
